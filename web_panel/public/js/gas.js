    ...
    if (isAdmin !== 'true') {
        document.querySelector('main').innerHTML = `
            <div style="text-align: center; margin-top: 80px;">
                ...
                <p style="color: #a0aec0; font-size: 1.2rem;">Standart kullanıcı hesabı ile sistem loglarına (Gaz/Yangın) erişim yetkiniz bulunmamaktadır.<br>Lütfen yalnızca size izin verilen "Canlı Kamera" modülünü kullanın.</p>
            </div>
        `;
        return;
    }
